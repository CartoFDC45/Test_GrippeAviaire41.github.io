...
ol.proj.get("EPSG:2154").setExtent([504246.102403, 6674345.721943, 702556.115018, 6785331.351943]);
var wms_layers = [];
...
jsonSource_Commune_grippeaviaire_0.addFeatures(features_Commune_grippeaviaire_0);
var lyr_Commune_grippeaviaire_0 = new ol.layer.Vector({
                declutter: true,
...
jsonSource_LGV_2.addFeatures(features_LGV_2);
var lyr_LGV_2 = new ol.layer.Vector({
                declutter: true,
...
jsonSource_Autoroute_3.addFeatures(features_Autoroute_3);
var lyr_Autoroute_3 = new ol.layer.Vector({
                declutter: true,
...
jsonSource_Prfctureetsousprfecture_5.addFeatures(features_Prfctureetsousprfecture_5);
var lyr_Prfctureetsousprfecture_5 = new ol.layer.Vector({
                declutter: true,
...
lyr_Dpartement_1.set('fieldAliases', {'ID_GEOFLA': 'ID_GEOFLA', 'CODE_DEPT': 'CODE_DEPT', 'NOM_DEPT': 'NOM_DEPT', 'CODE_CHF': 'CODE_CHF', 'NOM_CHF': 'NOM_CHF', 'X_CHF_LIEU': 'X_CHF_LIEU', 'Y_CHF_LIEU': 'Y_CHF_LIEU', 'X_CENTROID': 'X_CENTROID', 'Y_CENTROID': 'Y_CENTROID', 'CODE_REG': 'CODE_REG', 'NOM_REG': 'NOM_REG', 'SURF': 'SURF', 'auxiliary_storage_labeling_positionx': 'auxiliary_storage_labeling_positionx', 'auxiliary_storage_labeling_positiony': 'auxiliary_storage_labeling_positiony', });
...
lyr_Dpartement_1.set('fieldImages', {'ID_GEOFLA': 'TextEdit', 'CODE_DEPT': 'TextEdit', 'NOM_DEPT': 'TextEdit', 'CODE_CHF': 'TextEdit', 'NOM_CHF': 'TextEdit', 'X_CHF_LIEU': 'Range', 'Y_CHF_LIEU': 'Range', 'X_CENTROID': 'Range', 'Y_CENTROID': 'Range', 'CODE_REG': 'TextEdit', 'NOM_REG': 'TextEdit', 'SURF': 'TextEdit', 'auxiliary_storage_labeling_positionx': 'Hidden', 'auxiliary_storage_labeling_positiony': 'Hidden', });
lyr_LGV_2.set('fieldImages', {'ID': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'NATURE': 'TextEdit', 'ELECTRIFIE': 'TextEdit', 'FRANCHISST': 'TextEdit', 'LARGEUR': 'TextEdit', 'NB_VOIES': 'Range', 'POS_SOL': 'Range', 'ETAT': 'TextEdit', 'Z_INI': 'TextEdit', 'Z_FIN': 'TextEdit', });
lyr_Autoroute_3.set('fieldImages', {'ID': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'NATURE': 'TextEdit', 'NUMERO': 'TextEdit', 'NOM_VOIE_G': 'TextEdit', 'NOM_VOIE_D': 'TextEdit', 'IMPORTANCE': 'TextEdit', 'CL_ADMIN': 'TextEdit', 'GESTION': 'TextEdit', 'MISE_SERV': 'TextEdit', 'IT_VERT': 'TextEdit', 'IT_EUROP': 'TextEdit', 'FICTIF': 'TextEdit', 'FRANCHISST': 'TextEdit', 'LARGEUR': 'TextEdit', 'NOM_ITI': 'TextEdit', 'NB_VOIES': 'Range', 'POS_SOL': 'Range', 'SENS': 'TextEdit', 'ALIAS_G': 'TextEdit', 'ALIAS_D': 'TextEdit', 'INSEECOM_G': 'TextEdit', 'INSEECOM_D': 'TextEdit', 'CODEVOIE_G': 'TextEdit', 'CODEVOIE_D': 'TextEdit', 'CODEPOST_G': 'TextEdit', 'CODEPOST_D': 'TextEdit', 'TYP_ADRES': 'TextEdit', 'BORNEDEB_G': 'TextEdit', 'BORNEDEB_D': 'TextEdit', 'BORNEFIN_G': 'TextEdit', 'BORNEFIN_D': 'TextEdit', 'ETAT': 'TextEdit', 'Z_INI': 'TextEdit', 'Z_FIN': 'TextEdit', });
lyr_Coursdeau_4.set('fieldImages', {'ID': 'TextEdit', 'PREC_PLANI': 'TextEdit', 'PREC_ALTI': 'TextEdit', 'ARTIF': 'TextEdit', 'FICTIF': 'TextEdit', 'FRANCHISST': 'TextEdit', 'NOM': 'TextEdit', 'POS_SOL': 'Range', 'REGIME': 'TextEdit', 'Z_INI': 'TextEdit', 'Z_FIN': 'TextEdit', });
...
lyr_Dpartement_1.set('fieldLabels', {'ID_GEOFLA': 'no label', 'CODE_DEPT': 'no label', 'NOM_DEPT': 'no label', 'CODE_CHF': 'no label', 'NOM_CHF': 'no label', 'X_CHF_LIEU': 'no label', 'Y_CHF_LIEU': 'no label', 'X_CENTROID': 'no label', 'Y_CENTROID': 'no label', 'CODE_REG': 'no label', 'NOM_REG': 'no label', 'SURF': 'no label', });
